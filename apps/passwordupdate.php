              ...
              <div class="card-body">
                <form method="POST" action="login1.php" class="needs-validation" >
                  ...
                  <div class="form-group">
                    ...
                    <input id="newpass" type="text" class="form-control" name="newpass" tabindex="1" required autofocus>
                    ...
                    <input id="newpass1" type="text" class="form-control" name="newpass1" tabindex="1" required autofocus>
                    <div class="invalid-feedback">
