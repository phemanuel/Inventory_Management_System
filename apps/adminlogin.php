        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            <div class="card card-primary">
              ...
              <div class="card-body">
                <form method="POST" action="login2.php" class="needs-validation" >
                  ...
                  <div class="form-group">
                    ...
                    <input id="clientpass" type="password" class="form-control" name="clientpass" tabindex="1" required autofocus>
                    <div class="invalid-feedback">
