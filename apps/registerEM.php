...
$_SESSION['appversion'] = "Full" ;
$apptype = "EDUTECH MANAGEMENT SYSTEM" ;
$appabbrv = "EMS" ;
?>
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                <form method="POST" action="saveplan.php" enctype="multipart/form-data" class="needs-validation" >
                  ...
                  <div class="form-group">
                    <label for="email">App Plan</label>
                    <select name="clientplan1" id="clientplan1" class="form-control" required autofocus>
                  ...
                  <div class="form-group">
                    <label for="email">App Duration</label>
                    <select name="clientsub" id="clientsub" class="form-control" required autofocus>
