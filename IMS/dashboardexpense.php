                    ...
                    <div class="row ">
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                        <div class="card-content">
                          ...
                          <h2 class="mb-3 font-16"><strong><a href="files/expensesetup.php">EXPENSE NAME</a></strong></h2>
                     
                        </div>
                      </div>
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                        <div class="banner-img">
                          <a href="files/expensesetup.php"><img src="assets/img/banner/pm1.png" alt=""></a>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="align-items-center justify-content-between">
                    <div class="row ">
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                        <div class="card-content">
                          <h6 class="font-15 style1">&nbsp;</h6>
                          <h2 class="mb-3 font-16"><strong><a href="files/expenseid.php">EXPENSE ENTRY</a></strong></h2>
                     
                        </div>
                      </div>
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                        <div class="banner-img">
                          <a href="files/expenseid.php"><img src="assets/img/banner/d3.png" alt=""></a>
                        </div>
                      </div>
                    </div>
                  </div>
