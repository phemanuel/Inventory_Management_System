...
//====income trading(all)-------
$result4 = mysqli_query($conn,"SELECT SUM(amount_sold) AS value_sum FROM trading WHERE date1='$datekeep' and clientid='$clientid'"); 
...
$sum1 = $row1['value_sum'];
//------------------------------------
//====income gadget sales(all)-------
$result5 = mysqli_query($conn,"SELECT SUM(finalamount) AS value_sum FROM supply1 WHERE supplydate='$datekeep' and clientid='$clientid'"); 
$row5 = mysqli_fetch_assoc($result5); 
$sum5 = $row5['value_sum'];
//------------------------------------
//====income gadget sales(profit)-------
...
//------------------------------------
//====income trading(all)-------
$result7 = mysqli_query($conn,"SELECT SUM(totalamount_cl) AS value_sum FROM tradingbtc WHERE date1='$datekeep' and clientid='$clientid'"); 
                    ...
                    <div class="row ">
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                        <div class="card-content">
                          ...
                          <h2 class="font-15 style1">Total Sold</h2>
