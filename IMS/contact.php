                    ...
                    <div class="content-w3layouts-main">
                        ...
                        <div class="form-w3ls-left-info">
                            <form action="login1.php" method="post">
								...
								<p><span class="style2">Email : eitc@gmail.com
                                <br>
                                Mobile No : 07032689329
                                </span></p>
								<p>
								  <input name="fullname" type="text" id="fullname" placeholder="Company Name" required="" />
								  
								  
								  <input name="cliemailaddy" type="email" id="cliemailaddy" placeholder="Email Address" required="" />
								  
								  <input name="mobileno" type="text" id="mobileno" placeholder="Mobile No" required="" />
