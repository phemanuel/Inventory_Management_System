                  ...
                  <form>
                    ...
                    <div class="card-body">
                      <div class="form-group">
                        <label></label>
                                                           <p align="justify">The  objective of IMS 4.0 is to deliver an efficient inventory management system  whose main functionality apart from calculating the inventory include  predicting the requirement for the next demand to avoid been out of stock. It also takes care of the income and expenses to ensure accountability. <br>
                                          The  product also aims to keep track of the shelf life of resources, it would acknowledge to the manager (admin)  the details of the quantity. <br>
                                        ...
                                        <p align="justify">* Ease of use when it comes to updating inventory levels and  placing orders.</p>
