...
//------------------------------------
//====Expense DELIVERY-------
$result8 = mysqli_query($conn,"SELECT SUM(amount) AS value_sum FROM purchase1 WHERE purchasedate='$datekeep' and dept = 'DELIVERY' and clientid='$clientid'"); 
$row8 = mysqli_fetch_assoc($result8); 
$sum8 = $row8['value_sum'];
//------------------------------------
//====Expense GADGET-------
$result9 = mysqli_query($conn,"SELECT SUM(amount) AS value_sum FROM purchase1 WHERE purchasedate='$datekeep' and dept = 'GADGET' and clientid='$clientid'"); 
$row9 = mysqli_fetch_assoc($result9); 
$sum9 = $row9['value_sum'];
//------------------------------------
//====Expense EXCHANGE-------
$result10 = mysqli_query($conn,"SELECT SUM(amount) AS value_sum FROM purchase1 WHERE purchasedate='$datekeep' and dept = 'EXCHANGE' and clientid='$clientid'"); 
$row10 = mysqli_fetch_assoc($result10); 
$sum10 = $row10['value_sum'];
//------------------------------------
//====Expense ENTERPRISE-------
$result11 = mysqli_query($conn,"SELECT SUM(amount) AS value_sum FROM purchase1 WHERE purchasedate='$datekeep' and dept = 'ENTERPRISE' and clientid='$clientid'"); 
