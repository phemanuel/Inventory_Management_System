...
//====Expense DELIVERY-------
$result8 = mysqli_query($conn,"SELECT SUM(amount) AS value_sum FROM purchase1 WHERE purchasedate BETWEEN '" . $startdate . "' AND  '" . $enddate . "' and dept = 'DELIVERY' and clientid='$clientid'"); 
$row8 = mysqli_fetch_assoc($result8); 
$sum8 = $row8['value_sum'];
//------------------------------------
//====Expense GADGET-------
$result9 = mysqli_query($conn,"SELECT SUM(amount) AS value_sum FROM purchase1 WHERE purchasedate BETWEEN '" . $startdate . "' AND  '" . $enddate . "' and dept = 'GADGET' and clientid='$clientid'"); 
$row9 = mysqli_fetch_assoc($result9); 
$sum9 = $row9['value_sum'];
//------------------------------------
//====Expense EXCHANGE-------
$result10 = mysqli_query($conn,"SELECT SUM(amount) AS value_sum FROM purchase1 WHERE purchasedate BETWEEN '" . $startdate . "' AND  '" . $enddate . "' and dept = 'EXCHANGE' and clientid='$clientid'"); 
$row10 = mysqli_fetch_assoc($result10); 
$sum10 = $row10['value_sum'];
//------------------------------------
//====Expense ENTERPRISE-------
$result11 = mysqli_query($conn,"SELECT SUM(amount) AS value_sum FROM purchase1 WHERE purchasedate BETWEEN '" . $startdate . "' AND  '" . $enddate . "' and dept = 'ENTERPRISE' and clientid='$clientid'"); 
...
$totalexpense = ($sum6 + $sum7 + $sum8 + $sum9 + $sum10 + $sum11);
                    ...
                    <div class="row ">
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                        <div class="card-content">
                          <h5 class="font-15 style1">EXCHANGE</h5>
                ...
                <div class="card-statistic-4">
                  <div class="align-items-center justify-content-between">
                    <div class="row ">
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                        <div class="card-content">
                          <h5 class="font-15 style1">DELIVERY</h5>
                          <h2 class="mb-3 font-15"><img src="plus.png"> <?php echo number_format($sum8,2) ;?></h2>
                          
                        </div>
                      </div>
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                        <div class="banner-img">
                          <img src="assets/img/banner/d11.png" alt="">
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="card-statistic-4">
                  <div class="align-items-center justify-content-between">
                    <div class="row ">
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                        <div class="card-content">
                          <h5 class="font-15 style1">GADGET</h5>
                          <h2 class="mb-3 font-15"><img src="plus.png"> <?php echo number_format($sum9,2) ;?></h2>
                          
                        </div>
                      </div>
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                        <div class="banner-img">
                          <img src="assets/img/banner/pm2.png" alt="">
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="align-items-center justify-content-between">
                    <div class="row ">
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                        <div class="card-content">
                          <h5 class="font-15 style1">EXCHANGE</h5>
                          <h2 class="mb-3 font-15"><img src="plus.png"> <?php echo number_format($sum10,2) ;?></h2>
                     
                        </div>
                      </div>
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                        <div class="banner-img">
                          <img src="assets/img/banner/dt2.png" alt="">
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="card-statistic-4">
                  <div class="align-items-center justify-content-between">
                    <div class="row ">
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                        <div class="card-content">
                          <h5 class="font-15 style1">ENTERPRISE</h5>
                          <h2 class="mb-3 font-15"><img src="plus.png"> <?php echo number_format($sum11,2) ;?></h2>
