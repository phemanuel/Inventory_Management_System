...
if($_POST['btn_action'] == 'load_dept1')
	...
	if($_POST['btn_action'] == 'Add')
	{
		...
		$query = "
		INSERT INTO user_details (user_email, user_password, user_name, user_type, clientid, user_status,ADM,PMG,WMG,CMG,HRG,AMG,RPT,SMG,department,apptype,appabbrv) 
		VALUES (:user_email, :user_password, :user_name, :user_type, :clientid, :user_status,:checkbox1,:checkbox2,:checkbox3,:checkbox4,:checkbox5,:checkbox6,:checkbox7,:checkbox8,:dept,:apptype,:appabbrv)
		";	
	...
	if($_POST['btn_action'] == 'fetch_single')
	{
		...
		foreach($result as $row)
		{
			...
			$output['checkbox2'] = $row['PMG'];
			$output['checkbox3'] = $row['WMG'];
			$output['checkbox4'] = $row['CMG'];
			$output['checkbox5'] = $row['HRG'];
			$output['checkbox6'] = $row['AMG'];
