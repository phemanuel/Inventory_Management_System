...
if($page_number>=2){   
    ...
    echo "<li class='Previous'><a href='profitaccountalldate1.php?page=".($page_number-1)."'>  <strong>Prev</strong> </a></li>";   
...
for ($i=1; $i<=$total_pages; $i++) {   
  ...
  if ($i == $page_number) {   
      ...
      $pageURL .= "<li><a class = 'active' href='profitaccountalldate1.php?page="  
      ...
      $pageURL .= "<li><a href='profitaccountalldate1.php?page=".$i."'>   
...
if($page_number<$total_pages){   
    ...
    echo "<li class='Next'><a href='profitaccountalldate1.php?page=".($page_number+1)."'>  <strong>Next</strong> </a></i></li>";   
