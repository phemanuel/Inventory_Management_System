...
echo "<table class='table table-striped'><thead><tr><th>S/NO</th><th>STAFF NAME</th><th>ACTION</th></tr></thead>";
	 ...
	 //$c++ ;
         echo "<tr><td>" . ++$c. "</td><td>" . $row["user_name"]. "</td><td>"."<a class='btn btn-primary btn-action mr-1'data-toggle='tooltip' title='Performance Review' href='performancedashboardISP1.php?id=". $row["user_id"]."'>"."<i class='fas fa-pencil-alt'></i></a></td></tr>";
