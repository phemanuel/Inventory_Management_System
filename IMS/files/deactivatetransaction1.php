...
<div class="row"></div>
<form method="post" id="product_form" action="deactivatetransaction.php">
  <table width="100%" border="0">
    <tr>
      <td width="322"><div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title"><i class="fa fa-plus"></i> Trading Deactivation</h4>
        </div>
         <div class="modal-body"></div>
         <div class="modal-body">
           
          <div class="form-group">
            <label>Remark</label><p>
         ...
         <div class="modal-footer">
          ...
          <input name="button" type="submit" id="button"  class="btn btn-info" onclick="MM_goToURL('parent','edittrd.php');return document.MM_returnValue" value="Close" />
        </div>
