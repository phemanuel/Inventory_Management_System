...
if($_POST['btn_action'] == 'Add')
	...
	$profit = ($amount_sold - $customer_rate1);
		$query = "
		INSERT INTO trading (vendor_name, card_rate,amount_sold, rmb_value,customer_name,mobile_no,customer_rate,card_name,card_amount,profit,date1,time1,confirm_by,clientid,tradeid,status,transstatus,refcode,remark) 
		VALUES (:vendor_name, :card_rate,:amount_sold, :rmb_value,:customer_name,:mobile_no,:customer_rate,:card_name,:card_amount,:profit,:date1,:time1,:confirm_by,:clientid,:tradeid,:status,:transstatus,:refcode,:remark)
		";	
