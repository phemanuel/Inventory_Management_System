...
$sql = "SELECT itemname,amount,purchasedate,paymentmode,expensename,approvedby FROM purchase1 WHERE  dept='$deptkeep' and clientid='$clientid'  order by purchasedate DESC";
...
echo "<table class='table table-bordered table-striped'><thead><tr><th>S/NO</th><th>EXPENSE NAME</th><th>ITEM NAME</th><th>AMOUNT</th><th>DATE</th><th>APPROVED BY</th><th>PAYMENT MODE</th></tr></thead>";
	 ...
	 //$c++ ;
         echo "<tr><td>" . ++$c. "</td><td>" . $row["expensename"]. "</td><td>" . $row["itemname"]. "</td><td>"  . $row["amount"]. "</td><td>"  . $row["purchasedate"]. "</td><td>"  . $row["approvedby"]. "</td><td>"  . $row["paymentmode"]. "</td></tr>";
