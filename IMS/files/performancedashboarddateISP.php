            ...
            <div class="row">
              <div class="col-lg-8 col-md-12 col-12 col-sm-12">
                  ...
                  <div class="card-header">
                    <h4>STAFF PERFORMANCE REVIEW FOR <?php echo $staff_name ." between ". $startdate ." and " . $enddate ;  ?> </h4>
                  </div>
                  <div class="card-header">
                    <h4>Query by Date</h4>
                  </div>
...
$sql = "SELECT user_id,supplyid,totalquantity,totalamount,supplydate FROM supply1 WHERE confirmby = '$staff_name' and clientid='$clientid' and transstatus = 'Active' and supplydate BETWEEN '" . $startdate . "' AND  '" . $enddate . "' order by supplydate DESC LIMIT 5";
$result = $conn->query($sql);
//=============================
$sql3="SELECT * FROM supply1 WHERE confirmby = '$staff_name' and clientid='$clientid' and transstatus = 'Active' and supplydate BETWEEN '" . $startdate . "' AND  '" . $enddate . "'";
...
//$sql = "SELECT agentcode, agentname, agentpassword, agentstatus, date1 FROM gh WHERE ghvalue='0'";
$sql4 = "SELECT product_id,tradeid,card_name,customer_name,date1 FROM trading WHERE confirm_by = '$staff_name' and clientid='$clientid' and status = 'Active' and date1 BETWEEN '" . $startdate . "' AND  '" . $enddate . "'  order by date1 DESC LIMIT 4";
$result4 = $conn->query($sql4);
//=============================
$sql5="SELECT * FROM trading WHERE confirm_by = '$staff_name' and clientid='$clientid' and status = 'Active' and date1 BETWEEN '" . $startdate . "' AND  '" . $enddate . "'";
...
//$sql = "SELECT agentcode, agentname, agentpassword, agentstatus, date1 FROM gh WHERE ghvalue='0'";
$sql6 = "SELECT product_id,customer_name,item_name,date1 FROM delivery WHERE confirm_by = '$staff_name' and clientid='$clientid' and date1 BETWEEN '" . $startdate . "' AND  '" . $enddate . "'   order by date1 DESC LIMIT 4";
$result6 = $conn->query($sql6);
//=============================
$sql7="SELECT * FROM delivery WHERE confirm_by = '$staff_name' and clientid='$clientid' and date1 BETWEEN '" . $startdate . "' AND  '" . $enddate . "'";
...
//$sql = "SELECT agentcode, agentname, agentpassword, agentstatus, date1 FROM gh WHERE ghvalue='0'";
$sql8 = "SELECT pid,itemname,dept,purchasedate FROM purchase1 WHERE confirmby = '$staff_name' and clientid='$clientid' and status = 'Active' and purchasedate BETWEEN '" . $startdate . "' AND  '" . $enddate . "'  order by purchasedate DESC LIMIT 4";
$result8 = $conn->query($sql8);
//=============================
$sql9="SELECT * FROM purchase1 WHERE confirmby = '$staff_name' and clientid='$clientid' and status = 'Active' and purchasedate BETWEEN '" . $startdate . "' AND  '" . $enddate . "'";
...
//$sql = "SELECT agentcode, agentname, agentpassword, agentstatus, date1 FROM gh WHERE ghvalue='0'";
$sql10 = "SELECT product_id,customer_name,network_type,date1 FROM datainfo1 WHERE confirm_by = '$staff_name' and clientid='$clientid' and status = 'Active' and date1 BETWEEN '" . $startdate . "' AND  '" . $enddate . "'  order by date1 DESC LIMIT 5";
$result10 = $conn->query($sql10);
//=============================
$sql11="SELECT * FROM datainfo1 WHERE confirm_by = '$staff_name' and clientid='$clientid' and status = 'Active' and date1 BETWEEN '" . $startdate . "' AND  '" . $enddate . "'";
...
//$sql = "SELECT agentcode, agentname, agentpassword, agentstatus, date1 FROM gh WHERE ghvalue='0'";
$sql12 = "SELECT product_id,customer_name,network_type,date1 FROM airtime_info WHERE confirm_by = '$staff_name' and clientid='$clientid' and status = 'Active' and date1 BETWEEN '" . $startdate . "' AND  '" . $enddate . "'  order by date1 DESC LIMIT 5";
$result12 = $conn->query($sql12);
//=============================
$sql13="SELECT * FROM airtime_info WHERE confirm_by = '$staff_name' and clientid='$clientid' and status = 'Active' and date1 BETWEEN '" . $startdate . "' AND  '" . $enddate . "'";
