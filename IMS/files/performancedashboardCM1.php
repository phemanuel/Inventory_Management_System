...
//$sql = "SELECT agentcode, agentname, agentpassword, agentstatus, date1 FROM gh WHERE ghvalue='0'";
$sql4 = "SELECT product_id,tradeid,crypto_name,customer_name,date1 FROM tradingbtc WHERE confirm_by = '$staff_name' and clientid='$clientid' and status = 'Active'  order by date1 DESC LIMIT 4";
$result4 = $conn->query($sql4);
//=============================
$sql5="SELECT * FROM tradingbtc WHERE confirm_by = '$staff_name' and clientid='$clientid' and status = 'Active'";
$result5=mysqli_query($conn,$sql5);
