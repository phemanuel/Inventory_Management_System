...
<form method="post" id="product_form" action="paymentcheck.php">
  <table width="100%" border="0" align="center">
    <tr>
      <td width="121">&nbsp;</td>
      <td width="752"><div class="modal-content">
...
$sql = "SELECT supplyid,itembarcode,itemname,itemquantity,amount,supplydate FROM supply WHERE  supplydate BETWEEN '" . $startdate . "' AND  '" . $enddate . "' and  clientid='$clientid'  order by supplydate DESC LIMIT $initial_page, $limit";
...
if($page_number>=2){   
    ...
    echo "<li class='Previous'><a href='orderbydate1.php?page=".($page_number-1)."'>  <strong>Prev</strong> </a></li>";   
...
for ($i=1; $i<=$total_pages; $i++) {   
  ...
  if ($i == $page_number) {   
      ...
      $pageURL .= "<li><a class = 'active' href='orderbydate1.php?page="  
      ...
      $pageURL .= "<li><a href='orderbydate1.php?page=".$i."'>   
...
if($page_number<$total_pages){   
    ...
    echo "<li class='Next'><a href='orderbydate1.php?page=".($page_number+1)."'>  <strong>Next</strong> </a></i></li>";   
