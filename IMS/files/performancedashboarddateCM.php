        ...
        <section class="section">
            <div class="row">
              <div class="col-lg-8 col-md-12 col-12 col-sm-12">
                  ...
                  <div class="card-body">
                    <form class="form-inline" action="performancedashboarddateCM.php">
...
//$sql = "SELECT agentcode, agentname, agentpassword, agentstatus, date1 FROM gh WHERE ghvalue='0'";
$sql4 = "SELECT product_id,tradeid,crypto_name,customer_name,date1 FROM tradingbtc WHERE confirm_by = '$staff_name' and clientid='$clientid' and status = 'Active' and date1 BETWEEN '" . $startdate . "' AND  '" . $enddate . "'  order by date1 DESC LIMIT 4";
$result4 = $conn->query($sql4);
//=============================
$sql5="SELECT * FROM tradingbtc WHERE confirm_by = '$staff_name' and clientid='$clientid' and status = 'Active' and date1 BETWEEN '" . $startdate . "' AND  '" . $enddate . "'";
$result5=mysqli_query($conn,$sql5);
...
echo "<table class='table table-striped'><thead><tr><th>S/NO</th><th>CRYPTO NAME</th><th>CUSTOMER NAME</th><th>DATE</th></thead>";
     ...
     while($row = $result4->fetch_assoc()) {
	 //$c++ ;
         echo "<tr><td>" . ++$c. "</td><td>" . $row["crypto_name"]. "</td><td>" . $row["customer_name"]. "</td><td>" . $row["date1"]. "</td></tr>";
