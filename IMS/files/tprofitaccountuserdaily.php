...
<form method="post" id="product_form" action="paymentcheck.php">
  <table width="100%" border="0">
    <tr>
      <td width="55">&nbsp;</td>
      <td width="885"><div class="modal-content">
...
$sql = "SELECT product_id,customer_rate,amount_sold,vendor_name,customer_name,card_name,card_amount,card_rate,rmb_value,profit,date1,confirm_by FROM trading WHERE  date1='$datekeep' and confirm_by='$transname' and clientid='$clientid'  order by card_name ASC LIMIT $initial_page, $limit";
$result = $conn->query($sql);
//==============
$sql1="SELECT * FROM trading WHERE  date1='$datekeep' and confirm_by='$transname' and clientid='$clientid'  LIMIT $initial_page, $limit";
...
$getQuery = "SELECT COUNT(*) FROM trading WHERE  date1='$datekeep' and confirm_by='$transname' and clientid='$clientid'";     
...
if($page_number>=2){   
    ...
    echo "<li class='Previous'><a href='tprofitaccountuserdaily.php?page=".($page_number-1)."'>  <strong>Prev</strong> </a></li>";   
...
for ($i=1; $i<=$total_pages; $i++) {   
  ...
  if ($i == $page_number) {   
      ...
      $pageURL .= "<li><a class = 'active' href='tprofitaccountuserdaily.php?page="  
      ...
      $pageURL .= "<li><a href='tprofitaccountuserdaily.php?page=".$i."'>   
...
if($page_number<$total_pages){   
    ...
    echo "<li class='Next'><a href='tprofitaccountuserdaily.php?page=".($page_number+1)."'>  <strong>Next</strong> </a></i></li>";   
