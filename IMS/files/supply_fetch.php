...
foreach($result as $row)
{
	...
	$sub_array[] = '<a href="csupplyitem.php?id='.$row["product_id"].'" class="btn btn-danger btn-xs delete">Pre-Order</a>';
...
{
	$statement = $connect->prepare("SELECT * FROM product WHERE clientid = '".$_SESSION['clientid']."' AND product_quantity > 0 AND
